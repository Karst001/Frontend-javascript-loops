...
for (let i = 0; i < salaryDetails.length; i++) {
	console.log("Beste " + salaryDetails[i].name + ", je salaris van €" + salaryDetails[i].salary + ",- is zojuist overgemaakt. Val me aub nu niet meer lastig");
}
...
for (let i = 0; i < scores.length; i++) {
	if (scores[i].score < 60) {
		console.log("U krijgt 0%");
	}

	if (scores[i].score > 60 && scores[i].score < 69) {
		console.log("U krijgt 2%");
	}

	if (scores[i].score > 70 && scores[i].score < 89) {
		console.log("U krijgt 3%");
	}

	if (scores[i].score > 90 && scores[i].score < 99) {
		console.log("U krijgt 4%");
	}

	if (scores[i].score === 100) {
		console.log("U krijgt 6%");
	}
}
...
for (let i = 0; i < employees.length; i++) {
	emailAddress = employees[i].firstName + "." + employees[i].lastName + "@loop-it-solutions.nl";
...
for (let i = 0; i < employees.length; i++) {
	emailAddress = employees[i].firstName.toLowerCase() + "." + employees[i].lastName.toLowerCase() + "@loop-it-solutions.nl";
	employees[i].email = emailAddress;
}
console.log(employees);
